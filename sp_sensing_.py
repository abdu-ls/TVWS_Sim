...
N_MC = 5000                        # 10,000 Monte Carlo trials (Table 3.1)
SENSING_SAMPLES = 1024              # 2048 samples (Table 3.1)
SEQUENCE_LENGTH = 100               # Sequence length for LSTM
BATCH_SIZE = 128                    # Larger batch size for faster GPU training
EPOCHS = 50                        # 100 epochs for supervised learning (Table 3.1)
DRL_EPISODES = 500                 # 2000 episodes for DRL (Table 3.1)
N_EVAL_EPISODES = 500              # 1000 episodes for DQN evaluation
